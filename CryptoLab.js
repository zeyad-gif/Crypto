const portfolioData = [
  {
    ...
    title: "Caesar Cipher",
    description:
      "A classical substitution cipher that shifts letters in the alphabet by a fixed number, making it one of the simplest yet foundational encryption techniques.",
    image: "images/Caesar.png",
    tech: ["Shift", "Classic", "Beginner", "Monoalphabetic"],
  },
  {
    id: 2,
    title: "Vigenère Cipher",
    description:
      "A more advanced polyalphabetic cipher that uses a keyword to apply multiple shifts, providing stronger security compared to simple substitution methods.",
  ...
  },
  {
    ...
    title: "Affine Cipher",
    description:
      "A mathematical cipher that transforms letters using linear equations, combining multiplication and addition to create more complex encryption patterns.",
    image: "images/Affine.png",
    tech: ["Math", "Intermediate", "Monoalphabetic"],
  },
  {
    id: 4,
    title: "Hill Cipher",
    description:
      "An advanced encryption method that uses matrix multiplication to encode blocks of text, making it significantly stronger and more complex than basic ciphers.",
    image: "images/Hill.png",
    tech: ["Matrix", "Advanced", "Polygraphic"],
  },
  {
    id: 5,
    title: "OTP Cipher",
    description:
      "A theoretically unbreakable encryption technique that uses a truly random key of the same length as the message, ensuring perfect secrecy when applied correctly.",
  ...
  },
  {
    ...
    title: "SHA-256 Hash",
    description:
      "A one-way transformation that converts data into a fixed-length 256-bit string, widely used for data integrity, password storage, and secure verification.",
  ...
  },
  {
    ...
    description:
      "A substitution cipher where each letter is mapped to a unique letter based on a scrambled alphabet key, providing a fixed but simple encryption method.",
  ...
  },
  {
    ...
    description:
      "An enhanced substitution cipher using multiple alphabets to encrypt text, making frequency analysis significantly more difficult than monoalphabetic methods.",
    image: "images/Polyalphabetic.png",
    tech: ["Multi-Alphabet", "Intermediate", "Classic"],
  },
  {
    id: 9,
    title: "Rail Fence",
    description:
      "A transposition cipher that writes plaintext in a zigzag pattern across multiple 'rails' and then reads off each row to produce the ciphertext.",
  ...
  },
  {
    ...
    description:
      "A transposition cipher that writes text in rows under a keyword, then rearranges columns alphabetically by the keyword to produce the encrypted output.",
  ...
  },
  {
    ...
    title: "DES Cipher",
    description:
      "Data Encryption Standard — a symmetric-key block cipher that uses 56-bit keys and 16 rounds of Feistel network operations to encrypt 64-bit blocks.",
    image: "images/DES.png",
    tech: ["Symmetric", "Block", "Feistel", "Advanced"],
  },
  {
    id: 12,
    title: "AES Cipher",
    description:
      "Advanced Encryption Standard — the most widely used symmetric cipher operating on 128-bit blocks with key sizes of 128, 192, or 256 bits and 10-14 rounds.",
    image: "images/AES.png",
    tech: ["Symmetric", "Block", "SPN", "Advanced"],
  },
  {
    id: 13,
    title: "RSA Cipher",
    description:
      "An asymmetric public-key cryptosystem based on the mathematical difficulty of factoring large prime numbers, widely used for secure data transmission.",
  ...
  },
  {
    ...
    description:
      "A key exchange protocol that allows two parties to establish a shared secret over an insecure channel, forming the foundation for many secure communication systems.",
...
(function () {
  ...
  const CipherRegistry = {
    ...
    // Add these entries to the CipherRegistry object in CryptoLab.js:
